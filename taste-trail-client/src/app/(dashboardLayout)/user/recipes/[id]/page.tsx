                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-6 mb-12">
                            ...
                            {/* Instructions */}
                            <div>
                                <h3 className="text-lg font-bold text-gray-900 mb-4">Cooking Instructions</h3>
                                ...
                                <div className="border-t border-gray-200 pt-4 flex items-center gap-6">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div className="inline-block px-4 py-2 bg-blue-50 border border-blue-200 rounded-full">
                                            <p className="text-sm font-semibold text-blue-700">{recipe.categoryId?.name || "N/A"}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <p className="text-xs font-bold text-gray-500 uppercase tracking-wide">Cuisine Type</p>
                                        <div className="inline-block px-4 py-2 bg-green-50 border border-green-200 rounded-full">
                                            <p className="text-sm font-semibold text-green-700">{recipe.cuisineId?.name || "N/A"}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border-t border-gray-200 pt-4 space-y-3">
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-gray-700">Cooking Time</span>
                                        </div>
                                        <span className="font-semibold text-gray-900">{recipe.cookingTime} min</span>
                                    </div>
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center gap-2">
                                        ...
                                        <span className="font-semibold text-gray-900">{recipe.calories} kcal</span>
                                    </div>
                                </div>
