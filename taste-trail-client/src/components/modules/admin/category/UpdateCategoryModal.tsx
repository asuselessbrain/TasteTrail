...
import { categorySchema } from "./CreateCategoryModal"
...
export default function UpdateCategoryModal({ category }: { category: ICategory }) {
    const form = useForm({
    ...
    const handleUpdate = async (data: FieldValues) => {
        ...
        if(res.success){
            ...
            toast.error(res.errorMessage || "Failed to update category.")
        }
    }
        ...
        <DialogContent className="max-w-2xl">
            <DialogHeader>
                ...
                <DialogDescription className="text-gray-600">
                    Modify category details and click save to update
                </DialogDescription>
            </DialogHeader>
